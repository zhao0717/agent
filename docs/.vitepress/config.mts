...
export default defineConfig({
  lang: 'zh-CN',
  title: "知识工作台",
  description: "这是一个可私有部署的多租户知识智能体平台，统一 RAG、知识图谱、LangGraph 多智能体、MCP/Skills、沙盒与权限管理。",
  base,
  srcExclude: ['vibe/**'],
  head: [
    ['link', { rel: 'icon', href: `${base}favicon.svg` }],
    ['meta', { name: 'theme-color', content: '#F3BA32' }],
    ['meta', { name: 'keywords', content: 'AI Agent, RAG, knowledge graph, LangGraph, MCP, self-hosted, multi-agent, knowledge base' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:site_name', content: '知识工作台' }],
    ['meta', { property: 'og:title', content: '让知识真正参与每一次行动' }],
    ['meta', { property: 'og:description', content: '可私有部署的多租户知识智能体平台，统一知识、工具、多智能体执行与团队治理。' }],
    ['meta', { name: 'twitter:card', content: 'summary' }],
    ['meta', { name: 'twitter:title', content: 'Self-hosted knowledge agent platform' }],
    ...
    sidebar: [
      {
        text: '简介',
        items: [
          { text: '认识平台', link: '/intro/project-overview' },
          { text: '快速开始', link: '/intro/quick-start' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '工程迭代流程', link: '/develop-guides/spec-loop' },
