    ...
    try:
        async with session_factory() as db:
            ...
            model_message, _created = await model_repo.start(
                ...
                sequence=3,
                started_at=now,
                metadata={"tool_calls": [{"id": "call-tool-1", "name": "search", "args": {"q": "Workspace"}}]},
            )
            ...
            tool_message, created = await repository.start(
                ...
                tool_name="search",
                tool_input={"q": "effective Workspace"},
                sequence=5,
            ...
            assert completed.extra_metadata["input"] == {"q": "effective Workspace"}
            ...
            assert tool_call.tool_input == {"q": "effective Workspace"}
