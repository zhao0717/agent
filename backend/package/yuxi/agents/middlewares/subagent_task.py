...
TASK_TOOL_DESCRIPTION = """Launch a configured Workspace subagent to handle an isolated task.
...
SUBAGENT_START_DESCRIPTION = """Start a configured Workspace subagent asynchronously.
