...
class Message(Base):
    ...
    started_at = Column(DateTime, nullable=True, comment="Workspace 观察到操作开始的 wall-clock 时间")
    finished_at = Column(DateTime, nullable=True, comment="Workspace 观察到操作结束的 wall-clock 时间")
